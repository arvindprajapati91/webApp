    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_code', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='org_country', to='countryMaster.country_master')),
            ],
            options={
