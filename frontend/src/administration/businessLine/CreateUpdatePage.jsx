    ...
    getDetails = async () => {
        ...
        if (this.state.details !== "") {
            this.setState({
                ...
                bl_code: this.state.details.bl_code,
                bl_desc: this.state.details.bl_desc,
                    ...
                    <form id="app-form" onSubmit={this.handleSubmit} autoComplete="off">
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-3 col-sm-3 did-floating-label-content">
                                ...
                                <div className="form-helper helper_hide" id="bl_code_helper">
                                    Required
                                </div>
                            </div>
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-3 did-floating-label-content">
                                ...
                                <div className="form-helper helper_hide" id="bl_desc_helper">
                                    Required
                                </div>
                            </div>

                            <div className="col-lg-3 col-md-3 col-sm-3 did-floating-label-content">
                                <Dropdown className="did-floating-input" name="org_desc" id="org_desc" value={this.state.orgSelected} clearable placeholder={this.state.orgList.length > 0 ? 'Select State' : 'Loading...'} fluid search required={true} selection options={this.state.orgList} loading={this.state.orgList.length > 0 ? false : true} disabled={this.state.orgList.length > 0 ? false : true} onChange={(event, data) => { this.orgChange(event, data.value) }} />
