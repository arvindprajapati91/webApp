    ...
    getDetails = async () => {
        ...
        if (this.state.details !== "") {
            this.setState({
                ...
                status_desc: this.state.details.status_desc,
                    ...
                    <form id="app-form" onSubmit={this.handleSubmit} autoComplete="off">
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-3 col-sm-3 did-floating-label-content">
                                <input className="did-floating-input" type="text" placeholder=" " name="status_desc" id="status_desc" required value={this.state.status_desc} onChange={ChangeHandler.bind(this)} onClick={ChangeHandler.bind(this)} />
                                <label className="did-floating-label">Status Name</label>
                                <div className="form-helper helper_hide" id="status_desc_helper">Required</div>
                            </div>
                            <div className="col-lg-3 col-md-3 col-sm-3 did-floating-label-content">
